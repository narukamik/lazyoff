...
return (
    <Container>
      <HeaderTop>
        ...
        <Image style={{marginLeft: 15, marginTop: 50}} 
        source={require('~/assets/categorias/arrow_left.png')}/>  
        </TouchableOpacity>

        <Title style={{marginLeft: 35, marginTop: 20}}>De um nome a sua </Title>
    ...
    {/* borderWidth: 1, borderColor: "#ff0", */}
        ...
        <InputArea style={{width: "100%"}}>
            <Input  style={{marginLeft: -3,width: "90%"}} placeholder="Trabalho" />

            <TouchableOpacity style={{marginLeft: -45}}   onPress={() => {
        ...
        onRequestClose={() => {
          alert('Modal has been closed.');
            ...
            <View style={{backgroundColor: "#000000aa", flex:1, flexDirection: "row"}}>
                <View style={{borderWidth: 1, borderColor: "#EBEBEB", backgroundColor: "#FFFFFF", marginTop: "50%", 
                marginBottom: "80%", marginRight: "10%", marginLeft: "10%",padding:40,
                borderRadius: 20, flex:1, flexDirection: "row"}}>

                      <TouchableOpacity style={{marginLeft: -25, marginTop: -20, height: 25}} 
                        onPress={() => {
                        setModalVisible(false);
                       }}>

                       <Image 
                       source={require('~/assets/categorias/pintarNO.png')}/>

                       </TouchableOpacity>

                    {/* COLUNA 1*/}
                    <Coluna> 
                    <Bolinha style={{borderWidth: 2, borderColor: "#EBEBEB", 
